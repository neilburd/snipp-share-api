...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { code: @snippet.code, title: @snippet.title, user_id: @snippet.user_id } }, as: :json
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { code: @snippet.code, title: @snippet.title, user_id: @snippet.user_id } }, as: :json
    assert_response 200
  end
